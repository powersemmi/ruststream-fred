...
the code-cost benches under `crates/ruststream-fred-bench/benches`, one JSON object per
benchmark, each a service on the production broker against the stand. It writes the `code`
